...
1. [README.md](../README.md) → [evaluation/submission-checklist.md](./evaluation/submission-checklist.md) → `scripts/evaluate.py`
...
| 文档 | 对应代码 | 何时阅读 |
|------|----------|----------|
| [parser-backends.md](./ingest/parser-backends.md) | `src/pdf/`、`scripts/ingest.py` | mineru / docling / fusion |
